...
-->
		<div id="book" >
			...
			<div id="facebook_fixe" style="display: block; position: fixed; top: 350px;margin-left: -85px; height: 100px;">
				<iframe src="http://www.facebook.com/plugins/like.php?href=http%3A%2F%2Fwww.australian-rules.com%2F&layout=box_count&show_faces=false&width=70&action=like&colorscheme=light" scrolling="no" frameborder="0" allowTransparency="true" style="border:none; overflow:hidden; width:70px;"></iframe>
			</div>
...
<p align="right"><i>Australia(n) Rules, Mathieu Buzon<br>312 pages<br>Dépôt légal mars 2012<br>ISBN 9782746640603</i></p>
			  ...
			  <div class="content">
				<div id="bio" name="bio" class="acleft">
						<p>Né le 12 juin 1981, Mathieu Buzon vit toute son enfance dans un petit village de la campagne Lorraine. Après des études d'informatique, il décide de partir une année au Canada d'où il reviendra avec une idée : partir faire le tour de l'Australie pendant un an !
						</p>
					...
					<center>
						...
						<table>
						  <tr>
							...
							<td>
							  <select name="os0">
								<option value="Livre seul">Livre papier seul €14,90 EUR</option>
								<option value="Livre + Livraison">Livre papier + Livraison €19,50 EUR</option>
								<option value="Format Electronique PDF">Format Electronique PDF €2,99 EUR</option>
							  </select>
							</td>
						  </tr>
						</table>
